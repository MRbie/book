...
<body>
	...
	<form action="${basePath }system/userbook/borrow" method="post" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			...
			<d:table name="${list }" pagesize="5" requestURI="system/userbook/borrow" class="table table-hover table-condensed table-bordered">
